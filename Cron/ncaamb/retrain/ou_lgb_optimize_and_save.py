#!/usr/bin/env python3
"""
Over/Under LightGBM Model - Bayesian Optimization and Training
Loads all featuresYYYY.csv files, optimizes hyperparameters, trains final model
Saves to models/overunder/saved/lightgbm_model.pkl
"""
...
print("="*80)
print("OVER/UNDER LIGHTGBM - BAYESIAN OPTIMIZATION (250 ITERATIONS)")
print("="*80 + "\n")
...
if __name__ == "__main__":
    ...
    save_path = save_dir / "lightgbm_model.pkl"

    final_model.save_model(str(save_path))
    print(f"✓ Saved LightGBM model trained on features{years[0]}-{years[-1]}")
    print(f"  File: {save_path}")

    # Save hyperparameters
    params_path = save_dir / "lightgbm_hyperparameters.txt"
    with open(params_path, 'w') as f:
        f.write("LightGBM O/U Model Hyperparameters\n")
        f.write("="*50 + "\n\n")
